import type { QueryValue } from '../types/index.js';
...
/** Serializes an array as a JSON-bracket-encoded string, e.g. `[1,2,3]`, as expected by CurseForge list query parameters such as `categoryIds`, `gameVersions`, and `modLoaderTypes`. */
export function toArrayParam<T>(values: T[] | undefined): string | undefined {
